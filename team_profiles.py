...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="[Dev 1] 2411289",  # example: "2024-10123"
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="[Dev 3] 2411441",  # example: "2024-10789"
            full_name="[Dev 3] Victoria Casey D. Alano", # example: "Angelo Reyes"
            role="QA & Feature Engineer",
            specialization="Testing Diagnostics, Theme Engine & Controls",
            github_handle="@notvi-spes",          # example: "@areyes-cspc"
            avatar_icon=ft.Icons.BUG_REPORT,
            accent_color=ft.Colors.INDIGO_700,
            photo_url="https://avatars.githubusercontent.com/u/190576576?v=4",                 # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
